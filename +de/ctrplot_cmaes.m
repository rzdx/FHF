function ctrplot_cmaes(evfnnm,evn,fldnm,ptfnm)
d=2;
dfsigma=120;
...
while rtct<maxrtct
    ...
    while termi==0
        ...
        if mod(G,20)==1
            ploto(arx,evfnnm,evn,-100,-100,100,100,G,fldnm,ptfnm);
        end
    end
    ploto(arx,evfnnm,evn,-100,-100,100,100,G,fldnm,ptfnm);
end
...
function ploto(X,evfnnm,evn,xmin,ymin,xmax,ymax,G,fldnm,ptfnm)
...
saveas(fg,[fldnm,'contour_f',num2str(evn),'_g',num2str(G),ptfnm]);
hold off
close all
end